import {View, Text, TouchableOpacity, Alert, FlatList, RefreshControl, ActivityIndicator} from 'react-native'
...
export default function Profile() {
    ...
    const handleDeleteBook = async (bookId) => {
        try {
            ...
            Alert.alert("Successfully deleted", "Recommendation successfully deleted.");
        } catch (error) {
